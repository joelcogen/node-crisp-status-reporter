...
/**
 * CrispStatusReporter.prototype.__dispatchPollRequestData
 * @private
 * @param  {object}   data
 * @param  {function} fn_next
 * @return {undefined}
 */
CrispStatusReporter.prototype.__dispatchPollRequestData = function(
  data, fn_next
) {
  var self = this;
  ...
  var request_data_raw = {
    ...
    load       : {
      ...
      ram : ((data.ram.active || 0.0) / (data.ram.total || 1.0))
    }
  };
